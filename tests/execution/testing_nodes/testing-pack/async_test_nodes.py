...
class TestSelfConsumingExpansion(ComfyNodeABC):
    @classmethod
    def INPUT_TYPES(cls):
        return {
...
ASYNC_TEST_NODE_CLASS_MAPPINGS = {
    ...
    "TestSelfConsumingExpansion": TestSelfConsumingExpansion,
...
ASYNC_TEST_NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "TestSelfConsumingExpansion": "Test Self Consuming Expansion",
